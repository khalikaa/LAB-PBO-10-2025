...
public class Main {
    public static void main(String[] args) {
        ...
        // === OBJEK UBUR-UBUR LISTRIK ===
        UburUburListrik ubur1 = new UburUburListrik("Eksperimen", "Jelly3000");
        ubur1.setTahunProduksi(9999);
        ubur1.setWarna("Biru Listrik");
        ubur1.setKecepatan(10);

        System.out.println("\n=== UBUR-UBUR LISTRIK ===");
        System.out.println("Merek: " + ubur1.getMerek());
        System.out.println("Model: " + ubur1.getModel());
        System.out.println("Tipe: " + ubur1.getTipeKendaraan());
        System.out.println("Kecepatan: " + ubur1.getKecepatan());
        ubur1.mulai();
        ubur1.berhenti();
        System.out.println("Pajak (eksperimen): Rp" + ubur1.hitungPajak());
    }
}